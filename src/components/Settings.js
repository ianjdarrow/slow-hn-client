...
class Settings extends Component {
  ...
  constructor(props) {
    ...
    this.daySelector = this.daySelector.bind(this);
  }

  async updateTiming() {
    const interval = this.refs.interval.value;
    const offset = +this.refs.offset.value + ( this.refs.ampm.value === 'pm' ? 12 : 0);
    const anchorDay = +this.refs.day.value;

    await this.props.updateTimes(interval, offset, anchorDay);
    ...
    return (
      <div className='settings-day'>
        ...
        <select 
          ...
          ref='day' 
          defaultValue={ window.localStorage.slowHnAnchorDay }
        >
